 ...
 */
final class Version20200908135622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE banner (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, link_img VARCHAR(255) NOT NULL, link_video VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, target_id INT NOT NULL, title VARCHAR(255) NOT NULL, classification TINYINT(1) NOT NULL, address VARCHAR(255) NOT NULL, heading VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, photo_title VARCHAR(255) DEFAULT NULL, video VARCHAR(255) DEFAULT NULL, video_title VARCHAR(255) NOT NULL, pdf VARCHAR(255) DEFAULT NULL, needs VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_23A0E66158E0B66 (target_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66158E0B66 FOREIGN KEY (target_id) REFERENCES target (id)');
